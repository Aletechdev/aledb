...
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'ucsd system biology group')
...
DEFENDER_REDIS_URL = os.environ.get('REDIS_URL', 'redis://:Sup3RV1C383S7c0Ll480r470rn0c0lLus10N@aledb-redis:6379/1')
